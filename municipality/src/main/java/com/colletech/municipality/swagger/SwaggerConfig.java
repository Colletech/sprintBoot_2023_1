package com.colletech.municipality.swagger;
...
//				buscar los controller
				.apis(RequestHandlerSelectors.basePackage("com.colletech.municipality.controller")).build()
...
//				indico que requiere de token
	...
	private ApiInfo userApiInfo() {
		Contact contact = new Contact("Colletech", "https://colletech.pe/", "speed21@outlook.com");
		
		return new ApiInfoBuilder().contact(contact).title("Municipalidad").version("2.0")
				.termsOfServiceUrl("TERMS OF SERVICE URL").license("Apache License Version 2.0")
				.description("Microservicio con conexion a Mongo Atlas").build();
	}
